        ...
        <div className="row">
          <div className="cart-items">
            ...
            {products?.count?(products.products.map((product)=>
               <div className="item dir" key={product._id}>
                <div className="product-info">
                  <img src={product.details.mainImage.secure_url} className=''/>
                  <div className="product-details">
                    <h2>{product.details.name}</h2>
                    <span>{`اللون : ${product.details.color}`}</span>
              ...
              <button className='btn btn-outline-danger text-center mx-3 w-25' onClick={clearCart} disabled={count==0}>تفريغ السلة</button>
          ...
          <div className="row  dir">
            ...
            <div className="coupon-form">
              ...
              <input type="text" placeholder="أدخل الكود الخاص بالكوبون الذي تملكه" />
              <button>أرسل</button>
            </div>
          </div>
        </div>
